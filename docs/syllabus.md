...
| **Week 5 (Optional) – Treatment Pathway Analysis** | Sequence treatments and visualize pathways | *Book of OHDSI* — [Ch. 12: Treatment Pathways](https://ohdsi.github.io/TheBookOfOhdsi/PopulationLevelEstimation.html#treatment-pathways) | ATLAS Pathways · [Pathway Analysis Docs](https://ohdsi.github.io/Atlas/#/pathways) | Generate and interpret pathway plots · Summarize one analytical insight |
